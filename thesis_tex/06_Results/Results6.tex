...
In order to discuss the results for each case, an average error is calculated for each case. This is done from computing the arithmetical mean of the errors calculated for all the calibration images. And that result should be as close to zero as possible according to the literature in computer vision.

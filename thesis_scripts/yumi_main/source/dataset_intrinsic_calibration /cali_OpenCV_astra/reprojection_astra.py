...
def locate_target_orientation(frame,ret, corners):
    ...
    list_matrix= [513.31631904 ,  0., 309.82793059, 0., 512.65986368, 243.70121519,  0. ,  0., 1. ]
    cameraMatrix_ar=np.asarray(list_matrix).reshape(3,3)


    distCoef=[ 6.50156092e-02, -4.72152019e-01,  3.94309230e-03,  1.56479523e-04,   5.08204545e-01]
